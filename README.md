...
***ВАЖНО!***</br>
Ветка <ins>master</ins> является основной веткой - в ней лежит самая последняя версия проекта. Именно ее нужно использовать при клонировании проекта. Ветка <ins>main</ins> - разработка проекта, там находятся все этапы разработки и коммиты, сделанные во время разработки
