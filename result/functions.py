...
def do_command(command):
    if (command == "greeting"):
        ...
        examples = options["cmds"]["cdate"]["examples"]
        current_date = ""
        ...
        responses = options["cmds"]["weather_forecast"]["responses"]
        ...
        responses = options["cmds"]["google_search"]["responses"]
        ...
        responses = options["cmds"]["youtube_search"]["responses"]
        say(random.choice(responses))
        ...
        responses = options["cmds"]["wikipedia_search"]["responses"]
        say(random.choice(responses))
